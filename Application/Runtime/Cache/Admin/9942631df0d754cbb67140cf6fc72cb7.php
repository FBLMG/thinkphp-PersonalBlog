      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <!---图片区域---->
              <a href="<?php echo U('Images/imgmanger');?>?id=" style="font-size:14px;">
               <i class='icon-list-ul 
                 <?php if(($vo["id"]) == $_SESSION['imgs']): ?>text-info<?php endif; ?>'>
               </i> 所有
              </a>
            <?php if(is_array($imgtype)): foreach($imgtype as $key=>$vo): ?><a href="<?php echo U('Images/imgmanger');?>?id=<?php echo ($vo["id"]); ?>" style="font-size:14px;">
               <i class='icon-list-ul 
                 <?php if(($vo["id"]) == $_SESSION['imgs']): ?>text-info<?php endif; ?>'>
               </i> <?php echo ($vo["type"]); ?>
              </a><?php endforeach; endif; ?>
            <br /><br/>
            <?php if(is_array($imgdata)): foreach($imgdata as $key=>$vo): ?><!-----
          <a href="<?php echo U('Images/delimg','','');?>/id/<?php echo ($vo["id"]); ?>" onclick="if(!confirm('你确定要删除吗？')){return false;}">
                <img src="/blog/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" alt="<?php echo ($vo["title"]); ?>" class="img-thumbnail" width="140px" height="140px">
          </a>
         -------->
            <a href="<?php echo U('Images/editimg','','');?>/id/<?php echo ($vo["id"]); ?>">
                <img src="/blog/Public/img/uploads/imgs/<?php echo ($vo["img"]); ?>" alt="<?php echo ($vo["title"]); ?>" class="img-thumbnail" width="140px" height="140px">
            </a><?php endforeach; endif; ?>
 <!----图片区域---><br/><br/>
