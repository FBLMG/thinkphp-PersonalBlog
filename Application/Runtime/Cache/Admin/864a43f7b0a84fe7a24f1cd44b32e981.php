      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">         
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10" style="margin-bottom:60px;">用户管理
            </h2>
            <div class="panel panel-default no-border">
              <!---放入用户--->
               <?php if(is_array($date)): $i = 0; $__LIST__ = $date;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form method="post" id="userform" name="userform" class="form-horizontal">
               <input type="hidden" class="form-control" id="uid" name="uid" placeholder="uid" value="<?php echo ($vo["uid"]); ?>">
                <!------>
                <!------>
                   ...
                   <div class="ibox-content">
                      <div class="row">
                         <div id="crop-avatar" class="col-md-6">
                          <div class="avatar-view" style="width:60px;height:60px" title="点击修改图片">
                            ...
                            <img src="/blog/Public/img/uploads/userimg/<?php echo ($vo["user_img"]); ?>" alt="点击修改图片" style="width:60px;height:60px">
                          </div>
                         </div>
                    </div>
                  </div>
            <!----头像---->
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="username" name="username" placeholder="用户名" value="<?php echo ($vo["username"]); ?>">
                   </div>
                 </div>
                 <div class="form-group">
                   <label for="" class="col-sm-2">手机号码</label>
                   <div class="col-md-6 col-sm-10">
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-md-6 col-sm-10">
                   <input type="text" class="form-control" id="qq" name='qq' placeholder="qq" value="<?php echo ($vo["qq"]); ?>">
                   </div>
                 </div>
                 <div class="form-group">
                   <label for="" class="col-sm-2">地址</label>
                   <div class="col-md-6 col-sm-10">
                   <input type="text" class="form-control" id="address" name="address" placeholder="地址" value="<?php echo ($vo["address"]); ?>">
                   </div>
                 </div>
                 <div class="form-group">
                   <label for="" class="col-sm-2">级别</label>
                   <div class="col-sm-3">
                      <select class="form-control" id="state" name="state">
                  <?php if($vo["state"] == 0): ?><option value="0" selected="selected">管理员</option>
                      <option value="1">普通用户</option><?php endif; ?>
                  <?php if($vo["state"] == 1): ?><option value="0">管理员</option>
                      <option value="1" selected="selected">普通用户</option><?php endif; ?>
                      </select>
                   </div>
                 </div>
                 <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                     <button type="button" class="btn btn-default btn-success" onclick="edit()">确认</button>
                     <button type="button" class="btn btn-default btn-info" data-toggle="modal" data-target="#myModal">修改密码 </button>
                    </div>
                 </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
   ...
   <form method="post" name="userpwd" id="userpwd">
      <div class="modal-body">
         <div class="form-group">
            <label for="exampleInputPassword1">密码</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
        <button type="button" class="btn btn-primary" onclick="eidtuserpwd()">保存</button>
      </div>
  </form>
    </div>
  </div>
...
<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
  <div class="modal-dialog modal-lg"  style="width:1000px;">
    <div class="modal-content">
      <form class="avatar-form" action="<?php echo U('Usermanger/postimg',array('id'=>$uid));?>" enctype="multipart/form-data" method="post">
        <div class="modal-header">
...
function edit(){
    ...
    $.post('<?php echo U("Usermanger/edit");?>',data,function(response){
...
<script type="text/javascript">
    function eidtuserpwd(){
	  var pwd=$("#userpassword").val();
	  var id=$("#userid").val();
	  var ajaxSidUrl='<?php echo U("Usermanger/edituserpwd");?>'; 
	   $.ajax({
            //提交数据的类型 POST GET
            type: "POST",
           //提交的网址
