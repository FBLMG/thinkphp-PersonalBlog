      ...
      <!-- **放入管理者名字** -->
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="<?php echo U('Admin/Post/post');?>"  class="active"><i class="fa fa-bar-chart fa-fw"></i>发表</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">         
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">发表博客
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">添加类型
               </button>
               <button type="button" class="btn btn-success" data-toggle="modal" data-target="#edittype" style="width:80px;height:32px;border-radius:0px;">编辑类型
               </button>
            </h2>
            <p>请发表您的博客 </p>
            <div class="panel panel-default no-border">
              ...
              <br/>
         <!---发表区域--->  
          <form class="avatar-form" action="<?php echo U('Post/postfile');?>" enctype="multipart/form-data" method="post">
              <!-- 插入标题 -->
              ...
              <!-- 插入摘要-->
                 <div class="input-group">
                   ...
                   <input type="text" class="form-control" placeholder="摘要" id="abstract" name="abstract">
                 </div>
              <!-- 插入摘要 -->
              <br/>
              <!-- 插入封面-->
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span>       </button>
        <h4 class="modal-title" id="myModalLabel">新增文章类型</h4>
      </div>
   <form role="form" action="<?php echo U('Post/addtype');?>" method="post">    
      <div class="modal-body">    
           <div class="form-group">
           <label for="">文章类型</label>
           <input type="text" class="form-control" id="filestype" name="filestype" placeholder="文章类型">
           </div>
      </div>
      <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
...
///删除//
   function deletetype(){
	   var id=$('#oldtype').val();
	   var ajaxSidUrl='<?php echo U("Post/deletetype");?>'; 
	   ///
	   $.ajax({
           //提交数据的类型 POST GET
          type: "POST",
...
///编辑//
   function editype(){
	   ...
	   var ajaxSidUrl='<?php echo U("Post/edittyp");?>';
	  ////
	  /**/
	   $.ajax({
           //提交数据的类型 POST GET
