...
<link href="/blog/Public/zui/css/zui.css" rel="stylesheet">
...
<!----->
 <!-- Left column -->
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar" style="background-color:#000">
     ...
     <!-- **放入管理者名字** -->
        ...
        <nav class="templatemo-left-nav" style="height:650px;">
          <ul>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <!--博客-->
<?php if(is_array($fil)): $i = 0; $__LIST__ = $fil;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="items">
  <div class="item">
    <div class="item-heading">
      <div class="pull-right label label-success">主题</div>
      <h4><a href=""><?php echo ($vo["title"]); ?></a></h4>
    </div>
    <div class="item-content">
      <div class="media pull-left"><img src="/blog/Public/img/uploads/fileimg/<?php echo ($vo["img"]); ?>" alt="" width="64px" height="64px" ></div>
      <div class="text"><?php echo ($vo["content"]); ?></div>
    </div>
    <div class="item-footer">
      <a href="#" class="text-muted"><i class="icon-comments"></i>管理员： <?php echo ($vo["author"]); ?></a> &nbsp; <span class="text-muted">发表于<?php echo ($vo["publishtime"]); ?></span>
      <span>评论量：<?php echo ($knoecomment); ?>    浏览量：<?php echo ($knoeread); ?>  点赞数:<?php echo ($knowthumb); ?></span>
    </div>
</div><?php endforeach; endif; else: echo "" ;endif; ?>
          <!--博客-->
          <?php if(is_array($result)): foreach($result as $key=>$vo): ?><!---评论区域----->
  <div class="items">
  <div class="item">
    <div class="item-heading">
    ...
    <div class="item-content">
      <div class="media pull-left"><img src="/blog/Public/images/user.png" alt=""  width="64px" height="64px" class="img-rounded"></div>
      <div class="text"><p><?php echo ($vo["content"]); ?></p></div>
    </div>
    <div class="item-footer">
      <i class="icon-comments"></i>用户：<?php echo ($vo["uname"]); ?> &nbsp; <span class="text-muted">于<?php echo ($vo["publishtime"]); ?>评论</span>
    </div>
  </div>
            <!----评论区域----><?php endforeach; endif; ?>
          </div>
          <!--页数-->
