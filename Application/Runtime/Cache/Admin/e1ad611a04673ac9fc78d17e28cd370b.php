      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <table class="table table-hover">
            ...
            <?php if(is_array($result)): $key = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><!--循环-->
            <tr>
               <td><?php echo ($key); ?></td>
               <td style="text-overflow : clip;"><?php echo ($vo["messagecontent"]); ?></td>
               <td><?php echo ($vo["username"]); ?></td>
               <td><?php echo ($vo["publishtime"]); ?></td>
               <td>
               <?php if($vo["isreme"] == 1): ?>已回复
               <?php else: ?>
               未回复<?php endif; ?>
               </td>
               <td>
               <a type="button" class="btn btn-success btn-xs" href="<?php echo U('Message/editmes','','');?>/id/<?php echo ($vo["id"]); ?>">查看</a>
                <a type="button" class="btn btn-danger btn-xs" href="<?php echo U('Message/deletmess','','');?>/id/<?php echo ($vo["id"]); ?>" onclick="if(!confirm('你确定要删除吗？')){return false;}">
                删除
                </a>
               </td>
            </tr>
            <!--循环--><?php endforeach; endif; else: echo "" ;endif; ?> 
          </table>
