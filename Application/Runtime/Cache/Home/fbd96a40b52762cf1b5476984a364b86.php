                ...
                <div class="main-page">
                    ...
                    <div class="content-main contact-content">
                        <div class="contact-content-upper">   
                            <div class="row" >                               
                        <!---放入交流-->   
     <?php if($_SESSION['username']!= "" ): ?><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">发表</button><?php endif; ?>
       <br/>
        <?php if(is_array($result)): foreach($result as $key=>$vo): ?><!--交流区域-->
           <div class="item">
              <div class="item-heading">
                <div class="pull-right label label-success"><?php echo ($vo["states"]); ?></div>
                <h4><a href="<?php echo U('Reader/index');?>?id=<?php echo ($vo["id"]); ?>">标题：<?php echo ($vo["title"]); ?></a></h4>
              </div>
              <div class="item-content">
                 <div class="media pull-left"><img src="/blog/Public/img/uploads/userimg/<?php echo ($vo["user_img"]); ?>" alt="" width="46px" height="46px"></div>
                 <div class="text">
                  <?php echo ($vo["content"]); ?>
                 </div>
              </div>
              <div class="item-footer">
                   ...
                   <span class="text-muted"><?php echo ($vo["time"]); ?></span>
             </div>
            </div>
          </div>
          <br />
             <!--交流区域--><?php endforeach; endif; ?>  
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="width:700px;">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="onpost()">发表主题</button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript">
   function onpost(){
		var data=$("#postmessage").serialize();
			$.post('<?php echo U("Reader/postmessage");?>',data,function(response){
